...
The dynamics inherent in \eqref{eq:NORMAL} may be elucidated following the discussions of \cite{IA}, \cite{IK}, \cite{Lombardi1} and \cite{Lombardi2}.
...
in Figure 1 where the flow direction is deduced from \eqref{eq:normalA}.
