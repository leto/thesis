...
In order to investigate the possibility of a $ sech^2 $  homoclinic orbit in
...
computed by taking the $z$ derivative of \eqref{eq:c1cm} (using
\eqref{eq:c1nf} and \eqref{eq:psiexp2}) and read off the coefficients of $A^2,
\|C\|^2, C \epsilon$ and $AC$ terms.
