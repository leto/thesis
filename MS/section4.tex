...
In order to investigate the possibility of $ \textrm{sech}^2 $  homoclinic orbit in the neighborhood of $C_1$ and delocalized solitary
...
\bar{\nu}	    &=& -\frac{\epsilon}{q} \\
b_*		    &=& -\frac{b \Delta1}{3} \\
\lambda_\pm	    &=& \pm i \sqrt{-q} 
\end{eqnarray}
\end{subequations}
HERE

 Comparing to the linearized equations gives $d_0 = \sqrt{-q} $.
