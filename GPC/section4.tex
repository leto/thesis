...
Using \eqref{eq:c1nf} and \eqref{eq:c0nf} implies
\begin{equation}
...
With a  dominant balance argument after the change of variable $\epsilon = \sqrt{-3 \alpha}$ on the characteristic equation as $\lambda \rightarrow 0 $ 
we find $ d_1 = \frac{ \sqrt{-3 \alpha} }{18 \alpha^2 } $. 
Using $\alpha=q/3$ this implies 
\begin{equation}
...
The only coefficient left to determine is $d_2$ which we shall compute now. 
