...
The dynamics inherent in \eqref{eq:GPC1}, \eqref{eq:GPC2} may be elucidated following the discussions of \cite{blah},\cite{blah},\cite{blah} and \cite{blah}.
...
one may compute its expansion in powers of the bifurcation parameter up to any order (see \cite{asd} and \cite{adfad}). This is an example
...
higher order terms provided by the original system \cite{adf}. These solutions are delocalized waves and their existence in Region 2 is guaranteed
by the general theory for reversible systems in \cite{adsf} and \cite{adf}. Also, as mentioned in Section 2, genuine solitary waves are found on isolated
curves oin Region 2 of FIGURE on which the oscillation amplitudes vanish. Since these are embedded in the sea of delocalized solitary waves and in the 
continuous spectrum, they are referred to as embedded solitons \cite{adf}. These will further be investigated in Region 2 subsequently using a mix of
