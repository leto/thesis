...
form \eqref{eq:soliton} exist in the vicinity of $C_0$ for 

\begin{equation}
p > 0, q > 0 
\end{equation}

such that $k$ in \eqref{eq:soliton} is real. As mentioned in section 2, one may show the persistence
of this homoclinic solution in the original travelling wave ODE \eqref{eq:asdf}. Thus, we have 
