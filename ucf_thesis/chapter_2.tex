...
Matching the $\mathcal{O}\left(\mathrm{sech}^2\left(z\right)\right)$  and   $\mathcal{O}\left(\mathrm{sech}^4\left(z\right)\right)$ terms in \eqref{eq:hyper1} implies
\begin{subequations} 
\begin{eqnarray}
...
Matching the $\mathcal{O}\left(\mathrm{sech}^2\left(z\right)\right)$  and   $\mathcal{O}\left(\mathrm{sech}^4\left(z\right)\right)$ terms in \eqref{eq:hyperparty3} implies
