...
the $z$ derivative of \eqref{eq:c0cm2} (using \eqref{eq:c0nf2} and \eqref{eq:psiexpms}). 
...
and \eqref{eq:psiexpms}) and read off the coefficients of $A^2, \|C\|^2, C
\epsilon$ and $AC$ terms.  In the second way, $dY/dz$ is computed using
\eqref{eq:c1cm2} and \eqref{eq:psiexpms} in \eqref{eq:bilinearms2} (with $p=0$ on
